...
RAW_PATH = f"{Paths.raw_data}/archives"
TMP_PATH = f"{Paths.clean_data}/tmpTiff"
...
def process_date(date):
    ...
    None
    '''
    # get all relevant files in my raw dir.
    ...
    [generate_tif(x, y) for x, y in zip(file_paths, tif_paths)]
    
    # step 2. reproject these files
    [reproject_tif(x, y) for x, y in zip(tif_paths, reproject_paths)]
